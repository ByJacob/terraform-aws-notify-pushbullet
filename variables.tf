...
variable "sns_topic_name" {
  description = "The name of the SNS topic who exist. Set create_sns_topic to false if you want use existing sns topic"
  type        = string
  default     = ""
}
...
variable "pushbullet_api_keys" {
  description = "PushBullet acces tokens in map, example {\"user_name\":\"TOKEN_API\"}"
  sensitive   = true
  type        = map(string)
}
